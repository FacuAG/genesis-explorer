...
function normalizeBookName(bookStr) {
  ...
  if (b.startsWith('filip') || b.startsWith('flp')) return 'Philippians';
  if (b.startsWith('col')) return 'Colossians';
  if (b.startsWith('1 tes') || b.startsWith('1tes')) return '1 Thessalonians';
  if (b.startsWith('2 tes') || b.startsWith('2tes')) return '2 Thessalonians';
  ...
  if (b.startsWith('1 jua') || b.startsWith('1jn')) return '1 John';
  if (b.startsWith('2 jua') || b.startsWith('2jn')) return '2 John';
  if (b.startsWith('3 jua') || b.startsWith('3jn')) return '3 John';
  if (b.startsWith('jud')) return 'Judas';
  if (b.startsWith('apo') || b.startsWith('rev')) return 'Revelation';

  // Si ya coincide con una llave directa en fullBibleData

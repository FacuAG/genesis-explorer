        ...
        <div className="se-editor-column">
          ...
          <div className="se-toolbar">
            ...
            <div className="tb-group">
              ...
              <button className="tb-color-dot gold" onClick={() => applyHighlightColor('rgb(221, 199, 36)')} title="Resaltar en Amarillo (rgb(221 199 36))" />
              <button className="tb-color-dot blue" onClick={() => applyHighlightColor('rgb(63, 128, 163)')} title="Resaltar en Azul (rgb(63 128 163))" />
              <button className="tb-color-dot green" onClick={() => applyHighlightColor('rgb(85, 189, 122)')} title="Resaltar en Verde (rgb(85 189 122))" />
              <button className="tb-color-dot red" onClick={() => applyHighlightColor('rgb(183, 84, 116)')} title="Resaltar en Rosa/Rojo (rgb(183 84 116))" />
